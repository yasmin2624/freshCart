...
export default function WishList() {
  ...
  return (
    <>
      {wishlist.length > 0 ? (
        <div className="relative overflow-x-auto shadow-md sm:rounded-lg px-4 sm:px-10 md:px-14 bg-white dark:bg-gray-900">
            ...
            <tbody>
              {wishlist.map((product) => (
                ...
                >
                  ...
                  <td className="px-4 sm:px-6 py-4 text-gray-800 dark:text-white">
                    {product.title}
                  </td>
                  <td className="px-4 sm:px-6 py-4 text-gray-800 dark:text-white">
                    EGP {product.price}
                  ...
                  <td className="px-4 sm:px-6 py-4">
                    <button
                      ...
                      className="text-main bg-gray-100 dark:bg-gray-700 dark:text-white rounded-md p-2 border"
                    >
                  ...
                  <td className="px-4 sm:px-6 py-4">
                    <button
                      className="text-center text-red-700 dark:text-red-400 rounded-md px-3"
                      onClick={async () => {
        ...
        <div className="container mx-auto py-8 px-4 sm:px-10 md:px-14">
          <div className="flex justify-center py-8 flex-col items-center h-72">
            <h2 className="text-3xl text-gray-600 dark:text-gray-300 my-4">Empty List</h2>
